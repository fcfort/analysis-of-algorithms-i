...
public class RandomizedQueue<Item> implements Iterable<Item> {
    ...
    // For array resizing
	private static final double SCALE_UP_FACTOR = 2.0;
	private static final double SCALE_DOWN_FACTOR = 0.25;
    ...
    private class RandomizedQueueIterator implements Iterator<Item> {
        ...
        private void setIteratorArray(Item[] iteratorArray) {
