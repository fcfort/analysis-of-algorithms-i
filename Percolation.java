public class Percolation {
    ...
    private void unionIfOpen(int originI, int originJ, int adjacentI, int adjacentJ) {
        if ( inGrid(adjacentI,adjacentJ) ) {
            System.out.println("unionIfOpen, ("+adjacentI+","+adjacentJ+") are in grid");
        } else { return; }
        
        if ( field[adjacentI][adjacentJ] ) {
            System.out.println("unionIfOpen, ("+adjacentI+","+adjacentJ+") are open");
        }
